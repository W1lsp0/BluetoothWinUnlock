...
{
    { FID_TILE_IMAGE, CPFT_TILE_IMAGE, const_cast<PWSTR>(L"Bluetooth Unlock"), CPFG_CREDENTIAL_PROVIDER_LOGO },
    ...
    { FID_SUBMIT_BUTTON, CPFT_SUBMIT_BUTTON, const_cast<PWSTR>(L"Unlock"), CPFG_CREDENTIAL_PROVIDER_SUBMIT_BUTTON }
};
